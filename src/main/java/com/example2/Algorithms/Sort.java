...
public class Sort {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Time for sort bubble"+ timeForBubbleSort);
        double timeForSelectionSort= timeForSelectionSort(5);
        System.out.println("Time for selection sort "+ timeForSelectionSort);
        double timeForInsertionSort= timeForInsertionSort(5);
        System.out.println("Time for insertion sort "+ timeForInsertionSort);
    }
